...
class ReportFilterModalBottomSheet extends StatefulWidget {
  ...
  const ReportFilterModalBottomSheet({
    super.key,
    this.category,
    this.contact,
    this.type,
  ...
  @override
  State<ReportFilterModalBottomSheet> createState() =>
      _ReportFilterModalBottomSheetState();
}

class _ReportFilterModalBottomSheetState
    extends State<ReportFilterModalBottomSheet> {
  CategoryModel? category;
  ContactModel? contact;
  TransactionType? type;
  int? walletId;
