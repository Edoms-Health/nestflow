...
import 'package:nestflow/data/database/tables/tags_table.dart';
import 'package:nestflow/data/database/tables/transaction_tags_table.dart';
import 'package:nestflow/data/database/tables/transactions_table.dart';
...
class TransactionDao extends DatabaseAccessor<AppDatabase>
  ...
  getTotals({
    ...
    final selectFields = [
      ...
      "SUM(CASE WHEN t.type = 'transfer' THEN t.amount * COALESCE(t.currency_rate, 1) ELSE 0 END) AS total_transferred",
    ];
  ...
  ''';
    ...
    return (
      ...
      transferred: result.read<double?>('total_transferred') ?? 0.0,
    );
  }
