...
abstract class AppLocalizations {
  ...
  /// No description provided for @add_transfer_description.
  ///
  /// In en, this message translates to:
  /// **'Move money between your own wallets'**
  String get add_transfer_description;

  /// No description provided for @to_wallet.
  ///
  /// In en, this message translates to:
  /// **'To Wallet'**
  String get to_wallet;

  /// No description provided for @to_wallet_must_be_different.
  ///
  /// In en, this message translates to:
  /// **'Destination wallet must be different from the source wallet.'**
  String get to_wallet_must_be_different;
  ...
  /// No description provided for @no_eligible_wallet_for_transfer.
  ///
  /// In en, this message translates to:
  /// **'No other wallet available for transfer'**
  String get no_eligible_wallet_for_transfer;
}
